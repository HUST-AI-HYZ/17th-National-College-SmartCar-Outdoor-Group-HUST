...
extern float _PLACE_HOLDER_; // 鍗犱綅绗︼紝鐢ㄤ簬
 //主要是点，怎么保存呢？？ 
// Flash鍙橀噺鍒楄〃
#define FLASH_VAR_NUM	29  // 鍙傛暟涓?鏁? // 鏈�澶? 256 涓?鍙橀噺 // 256 * 4 Byte == 1KB
	...
	{(void *)&gps_kd_in, (uint8 *)NULL, TYPE_FLOAT},\
        ...
        {(void *)&speed_max_region[1], (uint8 *)NULL, TYPE_FLOAT},\
         ...
         {(void *)&distance_each_point_round, (uint8 *)NULL, TYPE_FLOAT},\
          {(void *)&direct_thres, (uint8 *)NULL, TYPE_UINT16},\
            {(void *)&whether_delay, (uint8 *)NULL, TYPE_INT16},\
              {(void *)&car_mode, (uint8 *)NULL, TYPE_UINT16},\
                 {(void *)&speed_max_region[3], (uint8 *)NULL, TYPE_FLOAT},\
                  {(void *)&circle_time, (uint8 *)NULL, TYPE_UINT16},\
                 {(void *)&stop_distance, (uint8 *)NULL, TYPE_FLOAT},\
								 {(void *)&start_thres, (uint8 *)NULL, TYPE_UINT16},\
								 {(void *)&guiding_mode, (uint8 *)NULL, TYPE_INT16},\
								 {(void *)&route_write, (uint8 *)NULL, TYPE_INT16},\
								 {(void *)&direc_change_dis, (uint8 *)NULL, TYPE_FLOAT},\
								  {(void *)&round_change_dis, (uint8 *)NULL, TYPE_FLOAT},\
									{(void *)&speed_step, (uint8 *)NULL, TYPE_FLOAT},\
         \ 
}
