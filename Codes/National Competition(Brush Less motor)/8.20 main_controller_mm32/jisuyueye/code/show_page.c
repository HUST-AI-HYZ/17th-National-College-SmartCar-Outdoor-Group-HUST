...
void page_spin()
{
    ...
    if (curpage != past_page || change == 1 || new_page % 5000 == 1)
    {
                ...
                //gps使用模式
                 {(void *)&gps_mode, "gps_mode", TYPE_INT16},
                  {(void *)&area_tag, "area_tag", TYPE_INT16},
									//运行圈数
                  {(void *)&circle_time, "crcl_tm", TYPE_UINT16},
                 //停车距离
                 {(void *)&stop_distance, "stp_dis", TYPE_FLOAT},
            };
            ...
            static Varible vars[6] = {
                ...
                {(void *)&duty_mid, "duty_mid", TYPE_INT32},
                 ...
                 {(void *)&distance_each_point_round, "dis_e_p_r", TYPE_FLOAT},
								 //起步阈值
                 {(void *)&start_thres, "strt_thrs", TYPE_UINT16},
        ...
        case SERVO_PAGE:
        {
            static Varible vars[6] = {
                ...
                {(void *)&duoji, "duoji", TYPE_FLOAT},
								//直道换点角度
								 {(void *)&direc_change_dis, "d_chg_dis", TYPE_FLOAT},
								 //弯道换点角度
								 {(void *)&round_change_dis, "r_chg_dis", TYPE_FLOAT},
        ...
        case SPEED_PAGE:
        {
            static Varible vars[5] = {
                ...
                {(void *)&speed_max_region[3], "spd_strt", TYPE_FLOAT},
								{(void *)&speed_step, "spd_step", TYPE_FLOAT},
        ...
        case MAX_PAGE:
        {
            ...
            static Varible vars[6] = {
                ...
                {(void *)&tp_micr_longi, "mc_longi", TYPE_INT16},
                 ...
                 {(void *)&direct_thres , "dir_thres", TYPE_UINT16},
    ...
    if (route_read != route_write)
    {
        ...
        run_sections = finished_gpspoints + 2;
